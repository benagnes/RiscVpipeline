...
add wave -noupdate -divider {Adder Signals}
add wave -noupdate -height 40 -radix decimal sim:/tb_multiplier/DUT/Add_Out 
add wave -noupdate -height 30 \
sim:/tb_multiplier/DUT/add_cout \
sim:/tb_multiplier/DUT/add_ovfl
